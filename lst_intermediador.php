...
<div class="base-topo">
    ...
    <div class="base-home">
		...
		<div class="titulo d-flex justify-content-space-between center-middle">
			<span><i class="fas fa-users h4 mb-0 ico_menu_color"></i>&nbsp; Lista de Intermediadores</span>
			<div>
				<a href="frm_intermediador.php" class="btn py-1 btn-azul btn-pequeno d-inline-block"><i class="fas fa-plus-circle"></i> Cadastrar intermediador</a>
	...
	<div class="bg-padrao mostraFiltro p-2 radius-4 mb-3">
		...
		<div>
			...
			<div class="col-12 mt-1 px-0">
				<div class="msg erro">
					<i class="fas fa-exclamation-triangle"></i> Cadastro não realizado !
			...
			<div class="col-12 mt-1 px-0">
				<div class="msg alerta">
					<i class="fas fa-exclamation-triangle"></i> Preencha todos os campos.
					<a href="javascript:;" onclick="fecharMsg()" class="fas fa-times float-right"></a>
				</div>
			</div>
		</div>
